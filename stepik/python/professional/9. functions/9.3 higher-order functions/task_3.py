...
filtered_names = filter(lambda x: len(x) > 4 and x[0].lower() in 'ам', names)
sorted_filtered_names = sorted(map(str.capitalize, filtered_names))
print(*sorted_filtered_names)
