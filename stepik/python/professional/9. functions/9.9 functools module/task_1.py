...
send_an_invitation = functools.partial(send_email,
...
# TEST_10:
print(
    to_Timur('Здравствуйте! Я Таня из компании Орифлэйм. Хочу предложить вам новую линейку курсов от Поколения Python')
)
