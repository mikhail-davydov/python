class ColoredPoint:
    ...
    def __repr__(self):
        ...
        attributes = self.x, self.y, self.color
        return f'{class_name}{attributes!r}'
    ...
    def __invert__(self):
        invert_color = tuple(x - y for x, y in zip((255, 255, 255), self.color))
        return self.__class__(self.y, self.x, invert_color)
